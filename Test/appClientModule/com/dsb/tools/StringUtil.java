...
public class StringUtil
{
     ...
     * @return
     */
    public static String getEllipsisMore(String text, String defaultStr) {
        ...
        String left = text.substring(0, len/2);
        String right = text.substring(text.length()-len/2);
        return left+defaultStr+right;
    }
    
    public static void main(String[] args) {
        System.out.println(getEllipsisMore("佛山市禅城区港口路26号P77", null));;
    }
}
