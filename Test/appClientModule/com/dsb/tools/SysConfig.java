...
public class SysConfig {
	private Properties props = null;// yunzhixun_sms.properties
	...
	public void loadConfigProps() {
		...
		try {
			is = getClass().getResourceAsStream(
					"/WEB-INF/classes/sys_config.properties");
			if (is == null) {
				is = getClass().getResourceAsStream("/sys_config.properties");
			}
			...
			e.printStackTrace();
//			log.error("load yunzhixun_sms.properties error!please check the file!", e);
		} finally {
			if (is != null) {
				try {
					is.close();
